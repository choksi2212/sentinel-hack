...
One row per dataset actually used. No row → excluded (`docs/manuals/akshat/DATASETS.md` §1). 9 fields:
...
## Flagged — NOT used pending human verification (`docs/manuals/akshat/DATASETS.md` §1: no row → excluded)
