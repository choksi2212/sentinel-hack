...
Below ~20px of plate height, fusion changes nothing:

| Bucket | plate height | fusion OFF | fusion ON |
|---|---|---|---|
...
This is an empirical floor measured on this corpus, not a scorer defect and
not a fusion failure — there is no readable frame anywhere in these tracks
for consensus to recover, by construction (fixed-distance tracks hold width,
